...
start_button = Button(text="Start", highlightthickness=0, padx=5, pady=5, border=1, font=(FONT_NAME, 10, "bold"))
start_button.config(command=lambda: start_timer())
start_button.grid(column=0, row=2)

reset_button = Button(text="Reset", highlightthickness=0, padx=5, pady=5, border=1, font=(FONT_NAME, 10, "bold"))
reset_button.config(command=lambda: reset_timer())
